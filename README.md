...
Dans cet atelier sont concerné les systèmes d'authentification de base, l'nnauthentifcation via l'utilisation de Cookies, via l'utilisation de mecanismes de Session et via les requêtes HTTP.  
